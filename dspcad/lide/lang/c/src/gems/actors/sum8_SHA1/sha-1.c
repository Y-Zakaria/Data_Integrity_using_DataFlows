...
//     //unsigned char *test =  "8sum8-application"; /// not equivalent to test[3] =  {'2','5','5'}; size bizare
//      //{'0'}; //{0x30,0x30,0x30,0x30}; //{8,0,0,0}; size bizare
    
//     unsigned char test[18] = {'8', 0x73,0x75,0x6D,0x38,0x2D,0x61,0x70,0x70,
//                                     0x6C,0x69,0x63,0x61,0x74,0x69,0x6F,0x6E, '\0'};
//     unsigned char hh[HS];  // hash output as 160 bit.
//     unsigned char ref[HS] = {0xFB, 0x5D, 0xBB, 0xCE, 0xA5, 0xCE, 0x7E, 0x29, 0x88,
//                              0xB8, 0xC6, 0x9B, 0xCF, 0xDF, 0xDE, 0x89, 0x04, 0xAA, 0xBC, 0x1F};
...
//             for(j =0; j<64; j++)
//             {
//                 SHA1Context.chunk[j] = test[j];
//             }
//             compute_inter_hashs();
//         }
        
//         padding_msg((test + length - i) ,length);
//         compute_inter_hashs();
//     }  
...
//     #ifdef VERIFY_HASH_FOR_SINK_ACTOR
//     for(i =0; i<HS; i++){
//         if (hh[i] != ref[i]){
//             printf("%02X %02X\n", hh[i], ref[i]);
//             printf("Integrity issue: data received is corrupted!\n");
//             print_hash_hex(hh,HS);
//             return 1;
//         }
//     }
//     #endif
